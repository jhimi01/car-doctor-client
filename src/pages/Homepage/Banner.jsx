...
const Banner = () => {
    return (
        <div className="carousel w-full h-[600px] mb-16">
        <div id="slide1" className="carousel-item relative w-full">
          <img src={img6}className="w-full rounded-xl" />
          <div className="absolute flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#1b1b1be3] to-[rgba(21, 21, 21, 0)] rounded-xl">
